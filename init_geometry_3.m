...
%%% back-iron case.
function theta_elec = init_geometry_3(g, theta, id, iq, hidewindow)
    ...
    main_resize(1100, 900);
    newdocument(0); % 0 = magnetics, 1 = electrostatics, etc..
    Freq = 0;
    mi_probdef(Freq, 'millimeters', 'planar', 1.e-8, g.depth, 20);
    ...
    if (g.n_s > g.s.slots / 2)
        ...
        addarc_group(g.s.boundary_point, [R_2' * g.s.boundary_point']', [0, 0], 'stator_backiron', 10, 3);
        addarc_group([R_2' * g.s.boundary_point']', p2', [0, 0], 'stator_backiron', 10, 3);

        addnode_group([R_2' * p1'], 'sa', 3);
        addarc_group(p1, [R_2' * p1']', [0, 0], 'stator_air', 10, 17);
        addarc_group([R_2' * p1']', [R' * p1']', [0, 0], 'stator_air', 10, 17);
    else
    ...
    if (g.n_p > g.r.ppairs)
        ...
        addnode_group([R_2' * p1], 'ra', 3);
        addarc_group(p1', [R_2' * p1]', [0, 0], 'rotor_backiron', 10, 17);
        addarc_group([R_2' * p1]', p2', [0, 0], 'rotor_backiron', 10, 17);

        addnode_group([R_2' * p3], 'ra', 3);
        addarc_group(p3', [R_2' * p3]', [0, 0], 'rotor_backiron', 10, 17);
        addarc_group([R_2' * p3]', p4', [0, 0], 'rotor_backiron', 10, 17);
