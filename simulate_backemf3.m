...
for j = 1:length(Current)
    ...
    init_geometry_4(g, InitialAngle, id, iq, 0)
    ...
    %         torq_vec', B_tooth_T', B_bkiron_T', Mag_B_vec', -Mag_H_vec'];
    % fid = fopen(['results/result_', g.name, '_', num2str(Current(j)), '.csv'], 'w');
    % fprintf(fid, 'step,time,PhA_amps,PhB_amps,PhC_amps,PhA_volts,PhB_volts,PhC_volts,PhA_webs,PhB_webs,PhC_webs,torque,B_tooth_T,B_bkiron_T,Mag_B,neg_Mag_H\n');
    % fclose(fid);
